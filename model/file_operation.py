...
def writeTrainedTuples(trained_tuples):
    with open(constants.FILES_PATH + "model.txt", "w", encoding="utf-8") as trainData:
...
def writeCalculatedValues():
    with open(constants.FILES_PATH + "values.txt", "w", encoding="utf-8") as calculateInfo:
...
def readCalculatedValues():
    with open(constants.FILES_PATH + "values.txt", "r", encoding="utf-8") as calculateInfo:
...
def readTrainedModelFile():
    with open(constants.FILES_PATH + "model.txt", "r") as trainData:
...
def getPredictionFileObj():
    f = open(constants.FILES_PATH + "result.txt", "w", encoding="utf-8")
    return f
